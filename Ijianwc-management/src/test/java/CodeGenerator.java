...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\IDEA WORKSPACE4\\IjianWC\\Ijianwc-management\\src\\main\\java");
        ...
        dsc.setUrl("jdbc:mysql://192.168.0.101:3306/ijianwc?useUnicode=true&useSSL=false&characterEncoding=utf8");
    ...
    /* 公共父类
     ...
     strategy.setSuperEntityColumns("id");*/
        strategy.setInclude("journal","catalog","conference");  //设置要要映射的表名
